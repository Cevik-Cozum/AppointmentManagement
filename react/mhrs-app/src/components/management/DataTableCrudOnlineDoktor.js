...
const DataTableCrudOnlineDoktor = () => {
    ...
    const [onlineDoktorName, setOnlineDoktorName] = useState({})
    ...
    // var A = new Date(bitisDate).getTime(); 
    // console.log("--------------"+A);
    ...
    const onClickSaveOnlineDoktor = event => {
        ...
        console.log("\"startDate\":"+Moment(bitisDate).format('YYYY-MM-DD HH:mm:ss'), Moment(baslangicDate).format('YYYY-MM-DD HH:mm:ss'), doktor.id);
